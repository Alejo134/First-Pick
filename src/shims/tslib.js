// Minimal tslib shim — solo los helpers que usa @supabase/functions-js
...
export var __rest = function(s, e) {
  var t = {}
...
export var __values = function(o) {
...
export var __read = function(o, n) {
...
export var __esDecorate = function() {}
export var __runInitializers = function() {}
export var __propKey = function(x) { return typeof x === "symbol" ? x : "".concat(x) }
export var __setFunctionName = function(f, name, prefix) {
  if (typeof name === "symbol") name = name.description ? "[".concat(name.description, "]") : ""
  return Object.defineProperty(f, "name", { configurable: true, value: prefix ? "".concat(prefix, " ", name) : name })
}
export var __addDisposableResource = function() {}
export var __disposeResources = function() {}
